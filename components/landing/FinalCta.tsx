...
export function FinalCta() {
  return (
    <section className="px-5 py-12 sm:px-8 sm:py-16">
      <div className="relative mx-auto max-w-5xl overflow-hidden rounded-[2rem] bg-rosa-700 px-7 py-16 text-center sm:px-14 sm:py-20">
        <div
        ...
        <SectionReveal className="relative mx-auto max-w-xl">
          ...
          <h2 className="mt-6 text-[2.2rem] leading-tight text-cream sm:text-[2.8rem]">
            Empieza tu boda con calma.
          </h2>
          <p className="mx-auto mt-4 max-w-md font-sans text-lg text-rosa-100/90">
          ...
          <p className="mt-4 font-sans text-sm text-rosa-200/70">
